              ...
              <v-card dark class="login__dialog">
                <div>
                  <iframe
                    width="100%"
                    height="400"
                    src="https://www.youtube.com/embed/ZerMJrGJ2VA"
                    frameborder="0"
        ...
        <div class="module-instruct__instructions">
          <div class="module-instruct__description-label">
            ...
            <v-tooltip right>
              <template #activator="{ on, attrs }">
                <a
                  href="https://discord.gg/s7PJ4QpZKk"
                  target="_blank"
...
export default defineComponent({
  ...
  setup() {
    ...
    const boilerInstructions = ref([
      ...
      'Communicate changes or make comments',
      'Sign agreements'
    ]);
    const goal = ref([
      'Review & signing contract, waiver, code of conduct & non-disclosure agreement'
    ]);
    // function populate() {
