  ...
  <div class="landing__container">
    ...
    <div>
      <iframe
        ...
        src="https://www.videoask.com/fsf07jdyv"
    ...
    <v-dialog v-model="announcement4" width="fit-content">
      <template #activator="{ on, attrs }">
        <div v-bind="attrs" v-on="on"></div>
      </template>
      <v-card width="800px" height="fit-content" color="black">
        <div class="videoask-black-background">
          ...
          <iframe
            width="800px"
            height="450px"
            src="https://www.youtube.com/embed/fC_6fa3ev_0"
            frameborder="0"
        ...
        <div class="d-flex flex-row justify-center align-center">
          <div class="ma-4">
            <a href="https://youtu.be/fC_6fa3ev_0" target="_blank" style="text-decoration: none">
              <v-btn small dark rounded outlined depressed class="font-weight-bold"
                ><v-icon left small color="red">mdi-youtube</v-icon>Open YouTube
              </v-btn>
            </a>
          </div>
          ...
          <div class="ma-4">
            <a
              href="https://us02web.zoom.us/j/81078291818"
              target="_blank"
              style="text-decoration: none"
            >
              <v-btn large dark rounded color="blue" depressed class="font-weight-bold"
                >Enter PilotCity
                <v-icon large class="" color="">mdi-television-box</v-icon> Zoom</v-btn
              >
            </a>
          </div>

          <div class="ma-4">
            <a href="https://discord.gg/XCU5CcuhFF" target="_blank" style="text-decoration: none">
              <v-btn small dark rounded outlined depressed class="font-weight-bold"
                ><v-icon left small class="" color="purple">mdi-discord</v-icon>Cowork in Discord
              </v-btn>
            </a>
          </div>
        </div>
            ...
            <v-card class="mobile__deliverable-card2">
              <v-container class="mt-auto mb-auto d-flex justify-center flex-column pa-0 ma-0">
                <div class="d-flex justify-center mt-8 mr-8 ml-8 flex-column">
                  <v-icon x-large color="green" class="mb-3">mdi-telegram</v-icon>
                  <div
                    class="
                      headline
                      font-weight-bold
                    ...
                    "
                  >
                    Complete your project at our digital hackathon!
                  </div>
